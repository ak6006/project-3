...
namespace project_3
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual ObjectResult<string> SP_Measurement_Add_New(string measurementName, ObjectParameter new_identity, ObjectParameter rec_found)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("SP_Measurement_Add_New", measurementNameParameter, new_identity, rec_found);
        }
        ...
        public virtual int SP_Measurement_Update(Nullable<int> measurementId, string measurementName, ObjectParameter rec_found)
        {
            var measurementIdParameter = measurementId.HasValue ?
                new ObjectParameter("MeasurementId", measurementId) :
                new ObjectParameter("MeasurementId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_Measurement_Update", measurementIdParameter, measurementNameParameter, rec_found);
        }
        ...
        public virtual int SP_Store_To_DataGrid_tmp()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_Store_To_DataGrid_tmp");
        }
